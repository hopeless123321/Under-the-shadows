...
@onready var tree_creature = $"../Tree creature"
@onready var ui_unit_prop = $"../Tree creature/UI unit prop"
const TIMER : float = 1.5
var to_main_enable : bool = true
var to_evolve_enable : bool = true

func _on_to_spell_mouse_entered():
...
func _on_to_main_mouse_entered():
	if to_main_enable:
		...
		#move_tween.tween_property(ui_unit_prop, "position", Vector2(0, -GlobalInfo.win_size.y), TIMER)
		await move_tween.finished
